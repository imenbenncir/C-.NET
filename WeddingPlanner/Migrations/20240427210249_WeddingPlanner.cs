...
namespace WeddingPlanner.Migrations
{
    ...
    public partial class WeddingPlanner : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WeddersUserId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Weddings_Users_WeddersUserId",
                        column: x => x.WeddersUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Weddings_WeddersUserId",
                table: "Weddings",
                column: "WeddersUserId");
        }
